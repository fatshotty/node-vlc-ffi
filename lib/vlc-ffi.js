...
var VLC = module.exports = function(libPath) {


    // bindings
    var libVLC = new ffi.Library(libPath || "libvlc", {
        // VLC Core
    ...
    this.__defineGetter__('compiler', function() {
        return libVLC.libvlc_get_compiler();
    });
    this.__defineGetter__('changeset', function() {
